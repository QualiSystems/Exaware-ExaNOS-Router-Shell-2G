...
from cloudshell.networking.exaware.cli.exaware_cli_handler import ExawareCli
...
class ExawareExaNOSShellDriver(
    ResourceDriverInterface, NetworkingResourceDriverInterface, GlobalLock
):
    SUPPORTED_OS = [r"Compass EOS"]
    SHELL_NAME = "Exaware ExaNOS Router 2G"

    def __init__(self):
        super(ExawareExaNOSShellDriver, self).__init__()
        self._cli = None
    ...
    def initialize(self, context: InitCommandContext) -> str:
        ...
        self._cli = ExawareCli(resource_config)
