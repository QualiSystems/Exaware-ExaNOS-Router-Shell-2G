...
# **Exaware ExaNOS Router Shell 2G**  
...
### **Exaware ExaNOS Router Shell 2G**
**Exaware ExaNOS Router Shell 2G** shell provides you with management capabilities such as device structure discovery. 

For more information on the device, see the vendor's official product documentation.

### Standard version
**Exaware ExaNOS Router Shell 2G** is based on the Networking Shell Standard version **5.0.4**.
...
Release: **Exaware ExaNOS Router Shell 2G**
...
#### **Exaware ExaNOS Router Shell 2G Attributes**
...
Please note, Exaware ExaNOS Router Shell has some limitations, and implements only the following commands:
- Inventroy
- Run Custom Command
...
The **Exaware ExaNOS Router Shell 2G** shell is available from the [Quali Community Integrations](https://community.quali.com/integrations) page. 
...
|:---|:---|
|Exaware ExaNOS Router Shell 2G.zip|Device shell package|
|cloudshell-networking-exaware-offline-deps.zip|Shell Python dependencies (for offline deployments only)|

# Importing and Configuring the Shell
This section describes how to import the **Exaware ExaNOS Router Shell 2G** shell and configure and modify the shell’s devices.
...
**To create a resource for the device:**
  ...
  2. From the list, select **Exaware ExaNOS Router Shell 2G**.
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/Exaware-ExaNOS-Router-Shell-2G/releases).
